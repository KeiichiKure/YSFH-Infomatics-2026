...
const terms = [
  ['①', '連続的', '切れ目なく変化する'], ['②', '離散的', '飛び飛びの値として表す'],
  ['③', '2進法', '0と1で数を表す方法'], ['④', '2進数', '2進法で表した数値'],
  ['⑤', 'ビット', '情報量の最小単位'], ['⑥', '8ビット', '8個のビットをまとめる'],
  ['⑦', '1バイト', '8ビットのまとまり'], ['⑧', '1024', '2の10乗'],
  ['⑨', '10進法', '0～9を使う表現方法'], ['⑩', '10進数', '10進法で表した数値'],
  ['⑪', '16進法', '0～9とA～Fを使う方法'], ['⑫', '16進数', '16進法で表した数値'],
  ['㉕', '1バイト', '英数字・記号などの基本'], ['㉖', '2バイト', 'JIS系での漢字などの表現'],
  ['㉗', '文字化け', '文字コードの不一致で別表示'], ['㉘', '機種依存文字', '旧来の環境差に注意'],
  ['㉙', '可変長', '文字ごとに使う長さが変わる'],
];
